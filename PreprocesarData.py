...
dia = np.where(dia == 1, 1, dia)
dia = np.where(dia == 2, 2, dia)
dia = np.where(dia == 3, 2, dia)
dia = np.where(dia == 4, 2, dia)
dia = np.where(dia == 5, 2, dia)
dia = np.where(dia == 6, 1, dia)
dia = np.where(dia == 7, 1, dia)
print(dia)
#dia=dia.reshape(-1, 1)
...
luz = np.where(luz == 'Darkeness: No street lighting', 4, luz)
print(luz)
...
clima = np.where(clima == 'Fine with high winds', 1, clima)
clima = np.where(clima == 'Raining without high winds', 2, clima)
clima = np.where(clima == 'Raining with high winds', 2, clima)
clima = np.where(clima == 'Snowing without high winds', 3, clima)
clima = np.where(clima == 'Snowing with high winds', 3, clima)
clima = np.where(clima == 'Fog or mist', 4, clima)
print(clima)
...
print("verificando nombres y valores unicos")
for col in dfSave.columns:
	print(col)
	print(dfSave[col].unique())
